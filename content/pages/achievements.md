...
### 競技プログラミング
- [AtCoder日本最強プログラマー学生選手権決勝](https://atcoder.jp/contests/jsc2019-final)出場 ([小川]({author}小川))
- AtCoderレート 青4名、水色2名など。
...
[株式会社GramEye](https://grameye.com/) はディープラーニングでグラム染色を自動化する医療機器の研究・開発を主とする企業であり、「AIを使い“薬剤耐性菌”に取り組む」ことをミッションに掲げています。代表取締役社長を務める**平岡悠**は本会正会員として大阪大学医学部在学中に株式会社GramEyeを起業しました。
