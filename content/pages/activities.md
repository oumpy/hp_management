...
また、機械学習を正しく理解し活用するためには**統計学**の知識が必須です。統計学は医学を含め様々な分野で用いられている学問です。統計学が深く関わる医学の分野として疫学や遺伝統計学などが挙げられますが、いかなる研究をする場合も統計学は理解しておくことが求められます。統計学の勉強を進める上では[統計検定](http://www.toukei-kentei.jp/)の受験を奨励しており、検定試験の直前期には臨時の勉強会を開催しています。
