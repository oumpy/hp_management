...
### 機械学習
機械学習のほげほげ
KaggleやSignateなどのデータサイエンスコンペティションへの参加
...
東京理研AIPで開かれた[第1回バイオインフォマティクス可視化セミナー](https://bioinfo.connpass.com/event/113579/)にて6年安水がpython 会の活動報告報告を行いました。
...
### 2018/10/23 RNA-seq会②
今日はpseudo-alignmentツールであるKallistoを使ったパイプラインの解説をしました。
