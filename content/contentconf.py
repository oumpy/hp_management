...
# 記事以外のページ (一覧・タグ・著者など) の <meta name="description"> / og:description
DEFAULT_METADESC = '大阪大学医学部Python会 (情報医科学研究会) の公式サイト。プログラミング・機械学習・バイオインフォマティクスなどの技術ブログと会の活動紹介。'
...
CUSTOM_PREVIOUS_ARTICLE_TITLE = "前の記事"
CUSTOM_NEXT_ARTICLE_TITLE = "次の記事"
